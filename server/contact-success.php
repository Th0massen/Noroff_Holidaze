...
$messagesList = file_get_contents('../client/Holidaze/src/contact.json');
...
file_put_contents('../client/Holidaze/src/contact.json', $jsonData);

header("Location: http://localhost:4200/contact", true, 301);
?>
